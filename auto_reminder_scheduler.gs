 ...
 *
 * What it does:
 * - Sends reminders ONLY to eictiitrprograms@masaischool.com
...
const CONFIG = {
  RECIPIENT: 'eictiitrprograms@masaischool.com',
  TIMEZONE: 'Asia/Kolkata',
  // Same public calendar CSVs used in dashboard:
  CALENDAR_CSV_URLS: [
    'https://docs.google.com/spreadsheets/d/e/2PACX-1vS15Clt2YM5iqAZnEioSWOo5ivYwg-FbCo2OSeSFhZZuAK-kbWHUrlBjFQt5eFLLAZVXN5fUrtgVYvZ/pub?gid=1512115812&single=true&output=csv', // DSAI
  ],
};
